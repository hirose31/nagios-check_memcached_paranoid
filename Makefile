...
LDFLAGS = $(NAGIOS_PLUGINS_DIR)/plugins/netutils.o $(NAGIOS_PLUGINS_DIR)/plugins/utils.o $(NAGIOS_PLUGINS_DIR)/lib/utils_base.o -rdynamic -L$(NAGIOS_PLUGINS_DIR)/plugins
